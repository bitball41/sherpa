...
/*!********************************************************!*\
  !*** C:\Users\cjnis\sherpa\src\client|sync|/^\.\/.*$/ ***!
  \********************************************************/
...
/* ESM import */var _mercuryworkshop_bare_mux__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @mercuryworkshop/bare-mux */ "./node_modules/.pnpm/@mercuryworkshop+bare-mux@2.1.9/node_modules/@mercuryworkshop/bare-mux/dist/index.mjs");
...
class SherpaClient {
    ...
    constructor(global){
        this.global = global;
        if (_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT in global) {
            console.error("attempted to initialize a sherpa client, but one is already loaded - this is very bad");
            throw new Error();
        }
        if (_entry__WEBPACK_IMPORTED_MODULE_8__.iswindow) {
            try {
                if (_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT in global.parent) {
                    this.box = global.parent[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT].box;
                }
            } catch  {}
            try {
                if (_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT in global.top) {
                    this.box = global.top[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT].box;
                }
            } catch  {}
            try {
                if (global.opener && _symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT in global.opener) {
                    this.box = global.opener[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT].box;
                }
            } catch  {}
            if (!this.box) {
		...
		*/ if (_entry__WEBPACK_IMPORTED_MODULE_8__.iswindow) {
        ...
        if (_entry__WEBPACK_IMPORTED_MODULE_8__.iswindow) {
            global.document[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT] = this;
        }
        ...
        this.meta = {
            ...
            get topFrameName () {
                ...
                while(currentWin.parent.window !== currentWin.window){
                    if (!currentWin.parent.window[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT]) break;
                    currentWin = currentWin.parent.window;
                }
                const curclient = currentWin[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT];
                ...
                if (!frame.name) {
                    ...
                    console.error("YOU NEED TO USE `new SherpaFrame()`! DIRECT IFRAMES WILL NOT WORK");
                    return null;
                }
                return frame.name;
            },
            get parentFrameName () {
                ...
                if (parentWin[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT]) {
                    // we're inside an iframe, and the parent is sherpa-controlled
                    const parentClient = parentWin[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT];
        ...
        global[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT] = this;
    }
    get frame() {
        ...
        const sframe = frame[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPAFRAME];
        if (!sframe) {
            // we're in a subframe, recurse upward until we find one
            let currentwin = this.global.window;
            while(currentwin.parent !== currentwin){
                let currentclient = currentwin[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT];
                let currentFrame = currentclient.descriptors.get("window.frameElement", currentwin);
                if (!currentFrame) return null; // ??
                if (currentFrame && currentFrame[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPAFRAME]) {
                    return currentFrame[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPAFRAME];
                }
                currentwin = currentwin.parent.window;
            }
        }
...
/* ESM default export */ function __WEBPACK_DEFAULT_EXPORT__(client, self) {
    ...
    client.Proxy("Element.prototype.getAttribute", {
        apply (ctx) {
            ...
            if (client.natives.call("Element.prototype.hasAttribute", ctx.this, `sherpa-attr-${name}`)) {
    ...
    client.Proxy("Element.prototype.getAttributeNames", {
        apply (ctx) {
            ...
            const cleaned = attrNames.filter((attr)=>!attr.startsWith("sherpa-attr"));
            ctx.return(cleaned);
        }
    });
    ...
    client.Proxy("Element.prototype.setAttributeNode", {
        apply (ctx) {
            ...
            const ownerElement = client.descriptors.get("Attr.prototype.ownerElement", attribute);
            ...
            const previousValue = self.Element.prototype.getAttribute.call(ctx.this, name);
            const previousAttribute = ctx.call();
            ...
            if (previousAttribute && previousValue !== null) {
                client.descriptors.set("Attr.prototype.value", previousAttribute, previousValue);
            }
    ...
    client.Proxy("Element.prototype.setAttributeNS", {
        apply (ctx) {
            ...
            if (ruleList) {
                ...
                client.natives.call("Element.prototype.setAttribute", ctx.this, `sherpa-attr-${ctx.args[1]}`, value);
            }
        }
    });
    ...
    client.Trap("Element.prototype.innerHTML", {
        set (ctx, value) {
            ...
            if (ctx.this instanceof self.HTMLScriptElement) {
                ...
                client.natives.call("Element.prototype.setAttribute", ctx.this, "sherpa-attr-script-source-src", bytesToBase64(encoder.encode(newval)));
        ...
        get (ctx) {
            if (ctx.this instanceof self.HTMLScriptElement) {
                const scriptSource = client.natives.call("Element.prototype.getAttribute", ctx.this, "sherpa-attr-script-source-src");
                if (scriptSource) {
    ...
    client.Trap([
        ...
        get (ctx) {
            ...
            if (!(_symbols__WEBPACK_IMPORTED_MODULE_5__.SHERPACLIENT in realwin)) {
                // hook the iframe before the client can start to steal globals out of it
                const newclient = new _client_index__WEBPACK_IMPORTED_MODULE_6__.SherpaClient(realwin);
                newclient.hook();
            }
            return realwin;
        }
...
/* ESM default export */ function __WEBPACK_DEFAULT_EXPORT__(client, _self) {
    client.Proxy([
        ...
        apply (ctx) {
            ...
            const callerClient = callerGlobalThisProxied[_symbols__WEBPACK_IMPORTED_MODULE_2__.SHERPACLIENT];
...
/* ESM default export */ function __WEBPACK_DEFAULT_EXPORT__(client) {
    client.Proxy("window.open", {
        apply (ctx) {
            ...
            if (_symbols__WEBPACK_IMPORTED_MODULE_1__.SHERPACLIENT in realwin) {
                return ctx.return(realwin[_symbols__WEBPACK_IMPORTED_MODULE_1__.SHERPACLIENT].global);
            } else {
                const newclient = new _client_index__WEBPACK_IMPORTED_MODULE_0__.SherpaClient(realwin);
    ...
    client.Trap("window.frameElement", {
        get (ctx) {
            ...
            if (win[_symbols__WEBPACK_IMPORTED_MODULE_1__.SHERPACLIENT]) {
...
/* ESM default export */ function __WEBPACK_DEFAULT_EXPORT__(client, _self) {
    ...
    client.Proxy("ServiceWorkerContainer.prototype.register", {
        apply (ctx) {
            ...
            const explicitScope = ctx.args[1]?.scope;
            const scope = explicitScope ? new URL(explicitScope, client.url.href).pathname : new URL(".", scriptURL).pathname;
            let url = (0,_rewriters_url__WEBPACK_IMPORTED_MODULE_1__.rewriteUrl)(ctx.args[0], client.meta) + "?dest=serviceworker&scope=" + encodeURIComponent(scope);
...
function loadAndHook(config) {
    ...
    if (!(_symbols__WEBPACK_IMPORTED_MODULE_1__.SHERPACLIENT in globalThis)) {
        (0,_shared_index__WEBPACK_IMPORTED_MODULE_0__.loadCodecs)();
        const client = new _client_index__WEBPACK_IMPORTED_MODULE_2__.SherpaClient(globalThis);
        ...
        client.hook();
        if (isemulatedsw) {
            const runtime = new _client_swruntime__WEBPACK_IMPORTED_MODULE_4__.SherpaServiceWorkerRuntime(client);
            runtime.hook();
        }
        const contextev = new _client_events__WEBPACK_IMPORTED_MODULE_3__.SherpaContextEvent(client.global.window, client);
...
__webpack_require__.d(__webpack_exports__, {
  ...
  SherpaContextEvent: () => (SherpaContextEvent),
  SherpaGlobalDownloadEvent: () => (SherpaGlobalDownloadEvent),
  UrlChangeEvent: () => (UrlChangeEvent)
});
/**
 * Event class for proxified download interception.
 */ class SherpaGlobalDownloadEvent extends Event {
    download;
    type = "download";
 ...
 */ class SherpaContextEvent extends Event {
    window;
    client;
    type = "contextInit";
...
__webpack_require__.d(__webpack_exports__, {
  ...
  SherpaClient: () => (/* reexport safe */ _client__WEBPACK_IMPORTED_MODULE_0__.SherpaClient),
  SherpaContextEvent: () => (/* reexport safe */ _events__WEBPACK_IMPORTED_MODULE_2__.SherpaContextEvent),
  SherpaGlobalDownloadEvent: () => (/* reexport safe */ _events__WEBPACK_IMPORTED_MODULE_2__.SherpaGlobalDownloadEvent),
  SherpaServiceWorkerRuntime: () => (/* reexport safe */ _swruntime__WEBPACK_IMPORTED_MODULE_5__.SherpaServiceWorkerRuntime),
...
/* ESM default export */ function __WEBPACK_DEFAULT_EXPORT__(client, self) {
    const handlers = {
        message: {
            ...
            origin () {
                if (typeof this.data === "object" && "$sherpa$origin" in this.data) return this.data.$sherpa$origin;
                return client.url.origin;
            },
            data () {
                if (typeof this.data === "object" && "$sherpa$data" in this.data) return this.data.$sherpa$data;
                return this.data;
            }
        },
        hashchange: {
...
/* ESM default export */ function __WEBPACK_DEFAULT_EXPORT__(client) {
    if (_client_entry__WEBPACK_IMPORTED_MODULE_0__.iswindow) client.Proxy("window.postMessage", {
        apply (ctx) {
            ...
            const callerGlobalThisProxied = Function("return globalThis")();
            const callerClient = callerGlobalThisProxied[_symbols__WEBPACK_IMPORTED_MODULE_1__.SHERPACLIENT];
...
const POLLUTANT = Symbol.for("sherpa realm pollutant");
/* ESM default export */ function __WEBPACK_DEFAULT_EXPORT__(client, self) {
...
/* ESM import */var _mercuryworkshop_bare_mux__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @mercuryworkshop/bare-mux */ "./node_modules/.pnpm/@mercuryworkshop+bare-mux@2.1.9/node_modules/@mercuryworkshop/bare-mux/dist/index.mjs");
/* ESM import */var _rewriters_url__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @rewriters/url */ "./src/shared/rewriters/url.ts");
    ...
    return function(identifier, strict) {
        ...
        if (_client_entry__WEBPACK_IMPORTED_MODULE_0__.iswindow) {
            if (identifier === self.parent) {
                if (_symbols__WEBPACK_IMPORTED_MODULE_1__.SHERPACLIENT in self.parent) {
                ...
                for(;;){
                    ...
                    if (!(_symbols__WEBPACK_IMPORTED_MODULE_1__.SHERPACLIENT in test)) break;
...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  SherpaServiceWorkerRuntime: () => (SherpaServiceWorkerRuntime)
});
/* ESM import */var _rewriters_url__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @rewriters/url */ "./src/shared/rewriters/url.ts");
/* provided dependency */ var dbg = __webpack_require__(/*! ./src/log.ts */ "./src/log.ts")["default"];

class SherpaServiceWorkerRuntime {
    client;
    recvport;
    constructor(client){
        this.client = client;
    ...
    hook() {
        ...
        const scope = scopePath ? this.client.url.origin + scopePath : this.client.url.href;
        // @ts-ignore
...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  SherpaController: () => (SherpaController)
});
/* ESM import */var _shared_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/shared/index */ "./src/shared/index.ts");
...
class SherpaController extends EventTarget {
    db;
    constructor(config){
        super();
        // sane ish defaults
        const defaultConfig = {
            ...
            siteFlags: {},
            errorPage: {
                ..._shared_index__WEBPACK_IMPORTED_MODULE_0__.DEFAULT_ERROR_PAGE
            },
            codec: {
                encode: (url)=>{
                    if (!url) return url;
    ...
    async init() {
        ...
        navigator.serviceWorker.addEventListener("message", (e)=>{
            ...
            if (data.sherpa$type === "download") {
                this.dispatchEvent(new _client_events__WEBPACK_IMPORTED_MODULE_3__.SherpaGlobalDownloadEvent(data.download));
            }
        });
    }
    createFrame(frame) {
        ...
        return new _controller_frame__WEBPACK_IMPORTED_MODULE_1__.SherpaFrame(this, frame);
    }
    encodeUrl(url) {
	 ...
	 * ```
	 */ get errorPreviewUrl() {
        return _shared_index__WEBPACK_IMPORTED_MODULE_0__.config.prefix + "$error";
    }
    async openIDB() {
        const db = await (0,idb__WEBPACK_IMPORTED_MODULE_2__.openDB)("$sherpa", 1, {
            upgrade (db) {
 ...
 * frame.reload();
 * ```
 */ class SherpaFrame extends EventTarget {
    controller;
    frame;
    /**
	 ...
	 */ constructor(controller, frame){
        ...
        frame.name = createFrameId();
        frame[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPAFRAME] = this;
    }
    /**
	 ...
	 */ get client() {
        return this.frame.contentWindow.window[_symbols__WEBPACK_IMPORTED_MODULE_0__.SHERPACLIENT];
    }
    /**
...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  SherpaController: () => (/* reexport safe */ _controller__WEBPACK_IMPORTED_MODULE_1__.SherpaController),
  SherpaFrame: () => (/* reexport safe */ _frame__WEBPACK_IMPORTED_MODULE_0__.SherpaFrame)
});
...
console.warn("you are using the last version of sherpa v1, if possible, please upgrade to v2 for better performance and more features");
 ...
 */ const DEFAULT_ERROR_PAGE = {
    ...
    accent: "#a1c5f3",
    accentText: "#222444",
    fontSans: '-apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
...
__webpack_require__.d(__webpack_exports__, {
  ...
  DEFAULT_ERROR_PAGE: () => (/* reexport safe */ _errorPage__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_ERROR_PAGE),
  SherpaHeaders: () => (/* reexport safe */ _headers__WEBPACK_IMPORTED_MODULE_2__.SherpaHeaders),
  asyncSetWasm: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.asyncSetWasm),
  cleanExpiredTrackers: () => (/* reexport safe */ _security__WEBPACK_IMPORTED_MODULE_5__.cleanExpiredTrackers),
  cleanTracker: () => (/* reexport safe */ _security__WEBPACK_IMPORTED_MODULE_5__.cleanTracker),
  codecDecode: () => (codecDecode),
  codecEncode: () => (codecEncode),
  config: () => (config),
  flagEnabled: () => (flagEnabled),
  getInjectScripts: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.getInjectScripts),
  getMostRestrictiveSite: () => (/* reexport safe */ _security__WEBPACK_IMPORTED_MODULE_5__.getMostRestrictiveSite),
  getPublicSuffixList: () => (/* reexport safe */ _security__WEBPACK_IMPORTED_MODULE_5__.getPublicSuffixList),
  getReferrerPolicy: () => (/* reexport safe */ _security__WEBPACK_IMPORTED_MODULE_5__.getReferrerPolicy),
  getRewriter: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.getRewriter),
  getSiteDirective: () => (/* reexport safe */ _security__WEBPACK_IMPORTED_MODULE_5__.getSiteDirective),
  htmlRules: () => (/* reexport safe */ _htmlRules__WEBPACK_IMPORTED_MODULE_3__.htmlRules),
  initializeTracker: () => (/* reexport safe */ _security__WEBPACK_IMPORTED_MODULE_5__.initializeTracker),
  isSameSite: () => (/* reexport safe */ _security__WEBPACK_IMPORTED_MODULE_5__.isSameSite),
  loadCodecs: () => (loadCodecs),
  rewriteBlob: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.rewriteBlob),
  rewriteCss: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.rewriteCss),
  rewriteHeaders: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.rewriteHeaders),
  rewriteHtml: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.rewriteHtml),
  rewriteJs: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.rewriteJs),
  rewriteJsInner: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.rewriteJsInner),
  rewriteSrcset: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.rewriteSrcset),
  rewriteUrl: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.rewriteUrl),
  rewriteWorkers: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.rewriteWorkers),
  setConfig: () => (setConfig),
  storeReferrerPolicy: () => (/* reexport safe */ _security__WEBPACK_IMPORTED_MODULE_5__.storeReferrerPolicy),
  textDecoder: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.textDecoder),
  unrewriteBlob: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.unrewriteBlob),
  unrewriteCss: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.unrewriteCss),
  unrewriteHtml: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.unrewriteHtml),
  unrewriteUrl: () => (/* reexport safe */ _rewriters__WEBPACK_IMPORTED_MODULE_4__.unrewriteUrl),
  updateTracker: () => (/* reexport safe */ _security__WEBPACK_IMPORTED_MODULE_5__.updateTracker)
});
/* ESM import */var _cookie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cookie */ "./src/shared/cookie.ts");
/* ESM import */var _errorPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./errorPage */ "./src/shared/errorPage.ts");
/* ESM import */var _headers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./headers */ "./src/shared/headers.ts");
/* ESM import */var _htmlRules__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./htmlRules */ "./src/shared/htmlRules.ts");
/* ESM import */var _rewriters__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./rewriters */ "./src/shared/rewriters/index.ts");
/* ESM import */var _security__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./security */ "./src/shared/security/index.ts");
...
function getInjectScripts(cookieStore, script) {
    ...
    const injected = `
		self.COOKIE = ${dump};
		$sherpaLoadClient().loadAndHook(${JSON.stringify(_shared__WEBPACK_IMPORTED_MODULE_6__.config)});
...
function rewriteWorkers(js, type, url, meta) {
    ...
    script("wasm");
    script("all");
    str += `$sherpaLoadClient().loadAndHook(${JSON.stringify(_shared__WEBPACK_IMPORTED_MODULE_0__.config)});`;
 ...
 */ async function getDB() {
    return (0,idb__WEBPACK_IMPORTED_MODULE_0__.openDB)("$sherpa", 1);
}
/**
...
__webpack_require__.d(__webpack_exports__, {
  SHERPACLIENT: () => (SHERPACLIENT),
  SHERPACLIENTNAME: () => (SHERPACLIENTNAME),
  SHERPAFRAME: () => (SHERPAFRAME)
});
/**
 * @fileoverview
 * See `types.ts` for context on these symbols.
 */ const SHERPACLIENTNAME = "sherpa client global";
const SHERPACLIENT = Symbol.for(SHERPACLIENTNAME);
const SHERPAFRAME = Symbol.for("sherpa frame handle");
...
/* ESM import */var _shared__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/shared */ "./src/shared/index.ts");
/* ESM import */var _shared_errorPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/shared/errorPage */ "./src/shared/errorPage.ts");
 ...
 */ function errorTemplate(trace, fetchedURL) {
    ...
    const theme = {
        ..._shared_errorPage__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_ERROR_PAGE,
        ..._shared__WEBPACK_IMPORTED_MODULE_0__.config?.errorPage ?? {}
    };
    ...
    const script = `
                ...
                version.textContent = ${JSON.stringify(globalThis.$sherpaVersion?.version || "unknown")};
                build.textContent = ${JSON.stringify(globalThis.$sherpaVersion?.build || "unknown")};
                ${theme.logo ? `logo.src = ${JSON.stringify(theme.logo)}; logo.hidden = false;` : ``}
...
class FakeServiceWorker {
    ...
    connected = false;
    constructor(handle, origin, scope){
        this.handle = handle;
        this.origin = origin;
        this.scope = scope;
...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  SherpaHandleResponseEvent: () => (SherpaHandleResponseEvent),
  SherpaRequestEvent: () => (SherpaRequestEvent),
...
/* ESM import */var _worker_request__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @/worker/request */ "./src/worker/request.ts");
/* ESM import */var _worker_retry__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @/worker/retry */ "./src/worker/retry.ts");
/* provided dependency */ var dbg = __webpack_require__(/*! ./src/log.ts */ "./src/log.ts")["default"];
...
async function fetchWithTransientRetry(client, url, init) {
    return (0,_worker_retry__WEBPACK_IMPORTED_MODULE_12__.retryTransientHttp2Request)(()=>client.fetch(url, init), init.method || "GET", init.body != null);
}
...
async function handleFetch(request, client) {
    try {
        ...
        if (requestUrl.pathname === this.config.prefix + "$error") {
            ...
            return (0,_worker_error__WEBPACK_IMPORTED_MODULE_0__.renderError)(sampleTrace, "https://example.com/");
        }
        let scriptType = "";
        let topFrameName;
        let parentFrameName;
        ...
        if (requestUrl.pathname.startsWith(`${this.config.prefix}blob:`) || requestUrl.pathname.startsWith(`${this.config.prefix}data:`)) {
            ...
            if (response.body) {
                body = await rewriteBody(response, meta, request.destination, scriptType, this.cookieStore, headers);
            }
            if (crossOriginIsolated) {
                headers["Cross-Origin-Opener-Policy"] = "same-origin";
                headers["Cross-Origin-Embedder-Policy"] = "require-corp";
        ...
        const matchingWorkers = this.serviceWorkers.filter((w)=>w.connected && w.origin === url.origin && url.pathname.startsWith(w.scope));
        ...
        const headers = new _shared_headers__WEBPACK_IMPORTED_MODULE_5__.SherpaHeaders();
        for (const [key, value] of request.headers.entries()){
            headers.set(key, value);
        }
        const requestContext = (0,_worker_request__WEBPACK_IMPORTED_MODULE_11__.createVirtualRequestContext)(request, client, url);
        headers.delete("Referer");
        headers.delete("Origin");
        const referer = (0,_worker_request__WEBPACK_IMPORTED_MODULE_11__.createRefererHeader)(requestContext);
        if (referer) headers.set("Referer", referer);
        const origin = (0,_worker_request__WEBPACK_IMPORTED_MODULE_11__.createOriginHeader)(requestContext);
        if (origin) headers.set("Origin", origin);
        const cookies = (0,_worker_request__WEBPACK_IMPORTED_MODULE_11__.shouldSendCookies)(requestContext) ? this.cookieStore.getCookies(url, false) : "";
        if (cookies.length) {
        ...
        if (requestContext.referrerUrl) {
            siteDirective = await (0,_shared_security_siteTests__WEBPACK_IMPORTED_MODULE_1__.getSiteDirective)(meta, requestContext.referrerUrl, this.client);
        }
        await (0,_shared_security_forceReferrer__WEBPACK_IMPORTED_MODULE_2__.initializeTracker)(url.toString(), requestContext.referrerUrl?.href || null, siteDirective);
        ...
        const ev = new SherpaRequestEvent(url, headers.headers, request.body, request.method, request.destination, client);
        this.dispatchEvent(ev);
        const response = await ev.response || await fetchWithTransientRetry(this.client, ev.url, {
            method: ev.method,
            body: ev.body,
        ...
        return await handleResponse(url, meta, scriptType, request.destination, request.mode, response, this.cookieStore, client, this.client, this, requestContext.referrerUrl?.href || "");
    } catch (err) {
        const errorDetails = {
            message: err.message,
            url: request.url,
...
async function handleResponse(url, meta, scriptType, destination, mode, response, cookieStore, client, bareClient, swtarget, referrer) {
    ...
    if (response.body && !isRedirect(response)) {
        responseBody = await rewriteBody(response, meta, destination, scriptType, cookieStore, responseHeaders);
    }
    ...
    const ev = new SherpaHandleResponseEvent(responseBody, responseHeaders, response.status, response.statusText, destination, url, response, client);
...
function detectHtmlCharset(buf, contentTypeHeader) {
    ...
    const prefix = new TextDecoder("windows-1252").decode(bytes.subarray(0, Math.min(1024, bytes.length)));
    const metaCharset = prefix.match(/<meta[^>]+charset=["']?([\w-]+)/i)?.[1];
    if (metaCharset) return metaCharset.toLowerCase();
    return "utf-8";
}
function decodeWithCharset(buf, charset) {
    try {
...
async function rewriteBody(response, meta, destination, workertype, cookieStore, responseHeaders) {
    switch(destination){
        case "iframe":
        case "document":
            if (response.headers.get("content-type")?.startsWith("text/html")) {
                const buf = await response.arrayBuffer();
                const charset = detectHtmlCharset(buf, response.headers.get("content-type"));
                ...
                responseHeaders["content-type"] = /charset=/i.test(responseHeaders["content-type"] || "") ? responseHeaders["content-type"].replace(/charset=[\w-]+/i, "charset=utf-8") : `${responseHeaders["content-type"] || "text/html"}; charset=utf-8`;
                return (0,_rewriters_html__WEBPACK_IMPORTED_MODULE_8__.rewriteHtml)(htmlContent, cookieStore, meta, true);
            } else {
...
class SherpaHandleResponseEvent extends Event {
    responseBody;
    responseHeaders;
    status;
    statusText;
...
class SherpaRequestEvent extends Event {
    url;
    requestHeaders;
    body;
    method;
...
__webpack_require__.d(__webpack_exports__, {
  ...
  SherpaHandleResponseEvent: () => (/* reexport safe */ _worker_fetch__WEBPACK_IMPORTED_MODULE_1__.SherpaHandleResponseEvent),
  SherpaRequestEvent: () => (/* reexport safe */ _worker_fetch__WEBPACK_IMPORTED_MODULE_1__.SherpaRequestEvent),
  SherpaServiceWorker: () => (SherpaServiceWorker),
...
/* ESM import */var _mercuryworkshop_bare_mux__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @mercuryworkshop/bare-mux */ "./node_modules/.pnpm/@mercuryworkshop+bare-mux@2.1.9/node_modules/@mercuryworkshop/bare-mux/dist/index.mjs");
 ...
 */ class SherpaServiceWorker extends EventTarget {
    /**
	 ...
	 */ constructor(){
        ...
        (async ()=>{
            const db = await (0,idb__WEBPACK_IMPORTED_MODULE_5__.openDB)("$sherpa", 1);
        ...
        addEventListener("message", async ({ data })=>{
            ...
            if (data.sherpa$type === "registerServiceWorker") {
                this.serviceWorkers.push(new _worker_fakesw__WEBPACK_IMPORTED_MODULE_0__.FakeServiceWorker(data.port, data.origin, data.scope));
                return;
            }
            if (data.sherpa$type === "cookie") {
            ...
            if (data.sherpa$type === "loadConfig") {
                ...
                (0,_shared__WEBPACK_IMPORTED_MODULE_6__.setConfig)(data.config);
            }
        });
    }
    /**
...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  createOriginHeader: () => (createOriginHeader),
  createRefererHeader: () => (createRefererHeader),
  createVirtualRequestContext: () => (createVirtualRequestContext),
...
function decodeProxyUrl(rawUrl) {
    if (!rawUrl || rawUrl === "no-referrer") return null;
    const prefix = location.origin + _shared__WEBPACK_IMPORTED_MODULE_0__.config.prefix;
    if (!rawUrl.startsWith(prefix)) return null;
    try {
        return new URL((0,_rewriters_url__WEBPACK_IMPORTED_MODULE_1__.unrewriteUrl)(rawUrl));
    } catch  {
        return null;
    }
}
function createVirtualRequestContext(request, client, targetUrl) {
...
function shouldSendCookies(context) {
    return context.isNavigation || context.credentials === "include" || context.credentials === "same-origin" && context.isSameOrigin;
}
function isDowngrade(source, target) {
    return source.protocol === "https:" && target.protocol === "http:";
}
function stripReferrer(url, originOnly = false) {
...
function createRefererHeader(context) {
    const source = context.referrerUrl;
    if (!source || ![
        "http:",
        "https:"
    ].includes(source.protocol)) return null;
...
function createOriginHeader(context) {
    const isCorsRequest = context.mode === "cors" && !context.isSameOrigin;
    const methodRequiresOrigin = ![
        "GET",
        "HEAD"
    ...
    switch(context.referrerPolicy){
        ...
        case "strict-origin":
        case "strict-origin-when-cross-origin":
            return isDowngrade(context.initiatorUrl, context.targetUrl) ? "null" : context.initiatorUrl.origin;
        case "same-origin":
...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  isRetryableHttp2GoAway: () => (isRetryableHttp2GoAway),
  retryTransientHttp2Request: () => (retryTransientHttp2Request)
});
const TRANSIENT_RETRY_METHODS = new Set([
    "GET",
    "HEAD",
    "OPTIONS"
]);
 ...
 */ function isRetryableHttp2GoAway(error) {
    const details = error instanceof Error ? `${error.message}\n${error.cause ? String(error.cause) : ""}` : String(error);
    return /\bhttp2\b/i.test(details) && /\bgoaway\b/i.test(details) && /\bno_error\b/i.test(details) && /\bremote\b/i.test(details);
}
async function retryTransientHttp2Request(request, method, hasBody) {
    try {
        return await request();
    } catch (error) {
        if (hasBody || !TRANSIENT_RETRY_METHODS.has(method.toUpperCase()) || !isRetryableHttp2GoAway(error)) {
            throw error;
        }
        console.warn("Sherpa: remote HTTP/2 connection closed gracefully; retrying request once");
        return request();
    }
}
...
"./node_modules/.pnpm/@mercuryworkshop+bare-mux@2.1.9/node_modules/@mercuryworkshop/bare-mux/dist/index.mjs": 
/*!******************************************************************************************************************!*\
  !*** ./node_modules/.pnpm/@mercuryworkshop+bare-mux@2.1.9/node_modules/@mercuryworkshop/bare-mux/dist/index.mjs ***!
  \******************************************************************************************************************/
...
class Rewriter {
     ...
     */
    constructor(sherpa) {
        const ret = wasm.rewriter_new(sherpa);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
...
__webpack_require__.r(__webpack_exports__);
__webpack_require__.d(__webpack_exports__, {
  $sherpaLoadClient: () => ($sherpaLoadClient),
  $sherpaLoadController: () => ($sherpaLoadController),
  $sherpaLoadWorker: () => ($sherpaLoadWorker),
 ...
 */ function $sherpaLoadWorker() {
    return __webpack_require__(/*! ./worker/index */ "./src/worker/index.ts");
}
globalThis.$sherpaRequire = function(path) {
...
;
//# sourceMappingURL=sherpa.all.js.map