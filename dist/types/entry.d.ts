 ...
 * @category Window Context
 */
export declare function $sherpaLoadController(): any;
/**
 ...
 * @category Window Context
 */
export declare function $sherpaLoadClient(): any;
/**
 ...
 * @category Service Worker Context
 */
export declare function $sherpaLoadWorker(): any;
/**
 * Version information for the current Sherpa build.
 *
 * @category Window Context
 */
export declare const $sherpaVersion: SherpaVersionInfo;
